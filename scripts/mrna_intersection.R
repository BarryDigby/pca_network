...
intersection = rbind(LNCAP_clone1, LNCAP_clone9, GSE88752_primary, GSE88752_secondary, GSE143408_day7, GSE143408_day14, GSE143408_day21, GSE78201_6MO)
intersection = intersection %>% group_by(Gene) %>% filter(length(unique(experiment))>=7) %>% ungroup()
