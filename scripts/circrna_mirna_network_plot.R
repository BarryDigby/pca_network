...
topology = intersection[,c(1,3)]
fold_change = data.frame(node=c(intersection$circrna,intersection$mirna),
                         fc=c(intersection$avg_circ_lfc,intersection$avg_mirna_lfc))
