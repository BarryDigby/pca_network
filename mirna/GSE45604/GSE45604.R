...
write.table(mat, "/data/github/pca_network/mirna/GSE45604/heatmap_counts.txt", sep="\t", quote=F, row.names = F)
write.table(dataGG, "/data/github/pca_network/mirna/GSE45604/heatmap_meta.txt", sep="\t", quote=F, row.names = F)
